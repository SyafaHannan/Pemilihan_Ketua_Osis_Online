...
<body class="login-page">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{url('/auth/login')}}" method="POST">
                    <div class="input-group mb-3"> <input type="email" id="Email" class="form-control" placeholder="Email">
                        <div class="input-group-text"> <span class="bi bi-envelope"></span> </div>
                    </div>
                    <div class="input-group mb-3"> <input type="password" id="Password" class="form-control" placeholder="Password">
                        <div class="input-group-text"> <span class="bi bi-lock-fill"></span> </div>
                    </div> <!--begin::Row-->
                    <div class="row">
                        <div class="float-sm-end">
                            <div class="d-grid gap-2"> <button type="submit" class="btn btn-primary btnLogin">Sign In</button> </div>
                        </div> <!-- /.col -->
                    </div>
            </div> <!--end::Row-->
            @csrf
    ...
    <script>
        ...
        $('.btnLogin').on('click', function(a) {
            ...
            axios.post("{{url('/auth/login')}}", data).then(function(response) {
