        ...
        <div class="container-fluid"> <!--begin::Row-->
            <div class="row">
                <div class="col-sm-6 d-flex">
                    ...
                    <btn class="btn btn-success  ModalTrigger ms-2" id="addButton" data-title="Tambah Forum" data-bs-target='#modalForm' data-bs-toggle="modal" attr-href="{{url('/admin/form-forum')}}"><i class='bi bi-plus-circle'></i> Tambah Forum</btn>
                    <btn class="btn btn-success ModalTrigger ms-2 d-none" id="addButtonAdmin" data-title="Tambah Akun Admin" data-bs-target='#modalForm' data-bs-toggle="modal" attr-href="{{url('/admin/form-forum')}}"><i class='bi bi-plus-circle'></i> Tambah Admin</btn>
                </div>
                <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <btn class="btn btn-primary  ModalTrigger" data-title="Edit Forum" data-bs-target='#modalForm' data-bs-toggle="modal" attr-href="{{url('/admin/modif-forum',$data->id_forum)}}"><i class='bi bi-pencil-square'></i></btn>
                                <form action="{{url('/admin/forum/hapus',$data->id_forum)}}" method="POST">
                                    @csrf
